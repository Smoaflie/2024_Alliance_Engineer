...
#define arm_pump_on_    0x0080
#define arm_pump_off_   0x0100
#define linear_pump_on_ 0x0200
#define linear_pump_off_ 0x0400
#define func_delay_     0x0800
...
uint8_t MonitorArmAutoRequest(const ARM_AUTO_MODE_* auto_mode, uint16_t selected_mode){
    ...
    Arm_Data_s* arm_data_sned_p = get_arm_data_send_p();
    ...
    if ((selected_mode_id==mode_id) || (auto_mode_doing_state == (0x0001<<mode_id))){
        ...
        uint8_t current_auto_mode_step_id = auto_mode_step_id[mode_id];
        ...
        if(auto_mode_step_id[mode_id] == auto_mode->step){
            ...
            memset(arm_data_sned_p,0,sizeof(Arm_Data_s));
            return 3;
        }else return 2;
    }else{
        return 0;
...
const AUTO_MODE_STEP_ Arm_get_goldcube_right_step[] = {
    {{.setting_total = arm_offset_ | height_range_},  800, 0,      0,      0,      0,      0,    -160,   20},
    {{.setting_total = arm_setting | height_offset_}, 4000, -118.019653,80.3512421,44.24086,0,0},
    {{.setting_total = arm_offset_ | height_setting}, 2000, 0,      0,      0,      0,      0,    -500},
    ...
    {{.setting_total = arm_setting | height_offset_ | arm_pump_on_}, 1000,-85.9664917,77.9112091,10.4933853,0, 0},
    {{.setting_total = arm_setting | height_offset_ | func_delay_}, 1000,-79.094635,60.0441895,34.6552238,0, 0,    0,  400},
    {{.setting_total = arm_setting | height_offset_ | func_delay_}, 1000,-70.5521851,49.5737457,34.3791924,0, 3,   0,  800},
    {{.setting_total = arm_setting | height_offset_}, 1000,-79.094635,60.0441895,34.6552238,0, 0, 50},
    {{.setting_total = arm_setting | height_offset_}, 1000,-100.219162,70.8017273,39.0113335,0, 0},
    {{.setting_total = arm_setting | height_offset_}, 1000,-110.731659,79.457222,39.0676384,0, 0},
    ...
    {{.setting_total = arm_offset_ | height_setting}, 2000, 0,      0,      0,      0,      0,    -65},
};
...
const AUTO_MODE_STEP_ Arm_walk_state_step[] = {
    {{.setting_total = height_range_},  2000,102.6894,-80.4619751,-83.837616,0, 90.5, -160, 20},
};
